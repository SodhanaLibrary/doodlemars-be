...
public class AnimationModelDAO {
	public static ArrayList<VarientDTO> getAnimationModels() throws DBException {
		Connection conn = null;
        PreparedStatement psInsert = null;
        ArrayList<VarientDTO> asrp = new ArrayList<VarientDTO>();
        try {
            conn = DBConn.getConnection();
            psInsert = conn.prepareStatement("select name, image, json from "+Constants.DB_TABLE_ANIMATION_VARIENTS+"");
	...
	public static void addAnimationModels(VarientDTO vdto) throws DBException {
		 Connection conn = null;
	        PreparedStatement psInsert = null;
	        try {
	            conn = DBConn.getConnection();
	            psInsert = conn.prepareStatement("insert into "
	                    + Constants.DB_TABLE_ANIMATION_VARIENTS + "(name, image, json) values (?,?,?)");
